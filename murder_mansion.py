...
def how_to_play() -> None:
    """
    Prints the story and the list of instructions for the player.
...
def developer_mode() -> str:
    ...
    Modes are 'player' (normal), and 'developer' (prints diagnostics), and
    'mapper' to be able to choose the map at game start.

    :return: 'set_mode' to allow other functions to print diagnostics.
    """
    while True:
        set_mode = "player"
...
def choose_game(
    ...
    for the game's code. Peaceful mode makes foe spawn almost impossible.

    :param provided_map_list: A list of available game maps.
    :param provided_mode: The mode generated by developer_mode().
    :return: 'chosen_map' for 'map_printer()' etc. to mine relevant map data.
    """
...
def initialize_map(provided_current_map: dict) -> tuple:
    ...
    Data is mined from the 'provided_current_map' for use here. It also
    generates foe and player starting co-ordinates etc.

    :param provided_current_map: The current game map.
    :return: Function returns 'initial_room', 'initial_y', 'initial_x',
    'initial_foe_appear', 'initial_d_map' for use in later functions.
    """
...
def example_maps(provided_mode: str) -> None:
    """
    Prints example maps while in 'developer' and 'mapper' modes.
...
def iterate_maps(
        ...
        provided_foe_two_y: int,
        provided_foe_two_x: int,
        provided_foe_two_flag: int,
        provided_foe_two_status: str
) -> None:
    """
    Prints all maps in the game files in 'developer' and 'mapper' modes.

    Prints all maps in the games files using the 'map_printer()'.
    This code does nothing in 'player' mode.

    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_map_list: The list of available maps for the game.
    ...
    :param provided_foe_appear: The turn the foe will appear on for the map.
    :param provided_d_map: The current discoverable game map.
    :param provided_foe_status: Whether the foe is present or has disappeared.
    :param provided_foe_two_y: The current foe_2 y co-ordinate.
    :param provided_foe_two_x: The current foe_2 x co-ordinate.
    :param provided_foe_two_flag: Whether foe_2 should appear yet or not.
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    """
    if provided_mode == "developer":
...
def main_loop(
        ...
        provided_foe_two_x: int,
        provided_foe_two_status: str,
        provided_win_condition: int,
        provided_all_evidence_turn_count: int,
        provided_reappear_two_count: int
) -> None:
    """
    ...
    feed back to call this function again. In developer mode diagnostics are
    printed. Player and foe co-ordinates are passed here to be available to
    'choose_direction()' later.

    :param provided_room: The current player room.
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_map_list: The current game map.
    :param provided_foe_y: The current foe y co-ordinate.
    :param provided_foe_x: The current foe x co-ordinate.
    :param provided_turn_count: The current turn number for the game.
    :param provided_foe_appear:  The turn the foe will appear on the map.
    :param provided_d_map: The current discoverable game map.
    :param provided_last_move: The last move the foe has made.
    :param provided_foe_status: Whether the foe is present of has disappeared.
    :param provided_reappear_count: The turn the foe is due to reappear.
    :param provided_evidence_list: The evidence to be found in the game.
    :param provided_found_list: The evidence the player has found.
    :param provided_foe_two_flag: Whether foe_2 is meant to appear or not.
    :param provided_foe_two_y: The current foe_2 y co-ordinate.
    :param provided_foe_two_x: The current foe_2 x co-ordinate.
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    :param provided_win_condition: The condition for triggering the end game.
    :param provided_all_evidence_turn_count: The turn number when all evidence
    has been found.
    :param provided_reappear_two_count: The turn foe_2 is due to reappear.
    """
...
def choose_direction(
    ...
    'provided_all_evidence_turn_count' for use in later functions.
    """
    foe_close(
        provided_foe_y,
        provided_foe_x,
...
def position_check(
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :param working_y: The working y co-ordinate of 'map_printer()'.
    :param working_x: The working x co-ordinate of 'map_printer()'.
    :param provided_foe_y: The current foe y co-ordinate.
    :param provided_foe_x: The current foe x co-ordinate.
    :param provided_turn_count: The current turn number for the game.
    :param provided_foe_appear:  The turn the foe will appear on the map.
    ...
    :param provided_foe_two_flag: Whether foe_2 is meant to appear or not.
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    :return: Function returns 'middle_room_object' for use in 'map_printer()'.
    """
...
def map_printer(
    ...
    Makes a string made of room objects in a row and then prints these
    strings to the output.

    :param provided_map_id: The 'map_ID' value for the game map.
    :param provided_danger_level: The 'danger_level' value for the game map.
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :param provided_foe_y: The current foe y co-ordinate.
    :param provided_foe_x: The current foe x co-ordinate.
    ...
    for index, row in enumerate(provided_d_map):
        ...
        for i in range(5):
            ...
            print_special(room_print)
    print("-------------------------------------------------------------------"
          "----------------")
    return provided_y, provided_x


# A function allow printing elements with colour constants.
def print_special(
        provided_text: str,
        colour: str = ""
) -> None:
    """
    Prints output making use of ANSI escape code colour and formatting.

    :param colour: Colour constant ANSI codes from 'murder_mansion_maps.py'.
    :param provided_text: The text to be printed by this function.
    """
    print_string = colour + provided_text
    print(print_string, RESET, default_colour)
...
def initialize_foe_two_position(provided_map: dict,
                                provided_mode: str,
                                provided_y: int,
                                provided_x: int
                                ) -> tuple:
    """
    Allows the placement of the foe_2 at the end of the game.

    Data is mined from the game's data files to determine foe_two y x.
    This function is only triggered when 'win_condition' == 1.

    :param provided_map: The current game map.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: 'new_foe_two_y', 'new_foe_two_x', 'new_foe_two_flag' for use in
    later functions.
    """
    while True:
...
def foe_two_entry(
    ...
    """
    Determines when 'foe_two' enters the game.

    A few turns after all evidence is collected, foe_two will enter the game.
    ...
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :return: 'provided_foe_two_flag', 'provided_foe_two_status' for use in
    later functions.
    """
    if provided_mode == "developer":
...
def foe_appearance(
    ...
    When the foe appear and current turn are equal the foe appears. Also calls
    'art_printer()' to print enemy art.
...
def foe_behave(
    ...
    :param provided_x: The current x co-ordinate.
    :param provided_reappear_count: The turn the foe is due to reappear.
    :param provided_name: The name of either the 'foe' or the 'accomplice'.
...
def foe_disappear(
    ...
    """
    Handles the disappearance of the foe(s).
    ...
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_name: The name of either the 'foe' or the 'accomplice'.
    :return: 'provided_foe_status', 'reappear_count', 'provided_reappear_count'
...
def foe_reappear(
    ...
    """
    Allows the reappearance of the foe(s) after they have disappeared.

    The foe(s) will reappear when gone when 'foe_reappear_count' matches current
    ...
    'reappear_flag' for use in later functions.
    """
    if provided_mode == 'developer':
...
def caught(
    ...
    :param provided_foe_status: Whether the foe is present of has disappeared.
    :param provided_name: The name of either the 'foe' or the 'accomplice'.
    :return: Function prints messages, and returns 'new_room', 'provided_y',
    'provided_x', 'caught_flag' for use in later functions.
    """
    if provided_foe_status == 'gone':
        new_room = provided_map["composition"][provided_y][provided_x]
        caught_flag = 0
...
def forced_move(
    ...
    """
    Moves the player to a valid next room in case of player and foe interaction.
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: 'new_room', 'provided_y', 'provided_x', 'provided_d_map' for use
    in later functions.
    """
...
def turn_counter(provided_turn_count: int) -> int:
    ...
    :param provided_turn_count: The current turn number for the game.
    :return: 'provided_turn_count' for use in later functions.
    """
...
def map_discover(
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: 'altered_d_map' for use in later functions.
    """
...
def assign_evidence(
    ...
    :param provided_map: The current game map.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :return: 'provided_evidence_list' for use in later functions.
    """
    initial_evidence_yx = []
    if provided_mode == 'developer':
...
def find_evidence(
    ...
    :param provided_evidence_list: The evidence to be found in the game.
    :param provided_found_list: The evidence the player has found.
    :return: 'filtered_evidence_list', 'provided_evidence_list',
    'provided_found_list' for use in later functions.
    """
...
def delete_by_yx(
    ...
    :param provided_evidence_list: The evidence to be found in the game.
    :param provided_target_yx: The co-ordinate room to have evidence deleted.
    :return: returns a processed form of 'provided_evidence_list'.
    """
...
def initialize_evidence() -> tuple:
    ...
    :return: Function returns 'game_evidence', 'initial_collected_evidence'
    for use in later functions.
    """
...
def evidence_count(
    ...
    :param provided_all_evidence_turn_count: The turn number when all evidence
    has been found.
    :return: 'new_win_condition', 'evidence_turn_count' to be used in later
    functions.
    """
    while True:
        if provided_win_condition != 1:
...
def art_printer(provided_art: str,
                colour: str = default_colour
                ) -> None:
    """
    Function to print ASCII art from the game's data files.

    :param colour: Provided colour constant to print a message in, these
    constants are imported from 'murder_mansion_maps.py'.
    :param provided_art: The art to be printed from 'murder_mansion_maps.py'.
    """
    print(colour, provided_art, RESET, default_colour)
...
def game_initialize() -> tuple:
    ...
    :return: Function returns 'i_mode', 'i_current_map', 'i_current_room', \
    'i_current_y', 'i_current_x', 'i_foe_appear', 'i_d_map', 'i_foe_y',
    'i_foe_x', 'i_turn_count', 'i_initial_last_move', 'i_foe_status',
    'i_reappear_count', 'i_evidence_list', 'i_game_found_evidence',
    'i_foe_two_flag', 'i_foe_two_y', 'i_foe_two_x', 'i_foe_two_status',
    'i_win_condition', 'i_all_evidence_turn_count', 'i_reappear_two_count' to
    be used at the start of the game.
    """
