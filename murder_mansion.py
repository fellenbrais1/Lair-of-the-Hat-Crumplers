...
def how_to_play():
    ...
    :return: Function prints messages, calls 'art_printer(), and returns 'None'.
    """
    print("\nSTORY:")
...
def developer_mode():
    ...
    :return: Function prints messages, and returns 'set_mode' for use in later
    functions.
    """
    while True:
        set_mode = "player"
...
def choose_game(
    ...
    :return: Function prints messages, and returns 'chosen_map' for use in
    later functions.
    """
...
def iterate_maps(
    ...
    :return: Function passes data to 'map_printer()', and returns 'None'.
    """
    if provided_mode == "developer":
...
def main_loop(
    ...
    :return: Functions passes data to other functions, and returns 'None'.
    """
...
def choose_direction(
    ...
    'provided_x', 'provided_win_condition', 'provided_all_evidence_turn_count'
...
def map_printer(
    ...
    :param provided_foe_two_flag: Whether foe_2 is meant to appear or not.
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    :return: Function prints messages, and returns 'provided_y', 'provided_x'
    for use in later functions.
    """
...
def initialize_foe_position(provided_map):
    ...
    :param provided_map: The current game map.
    :return: Function returns 'initial_foe_y', 'initial_foe_x' for use in
    later functions.
    """
...
def initialize_foe_two_position(provided_map,
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: Function returns 'new_foe_two_y', 'new_foe_two_x',
    'new_foe_two_flag' for use in later functions.
    """
    while True:
...
def foe_two_entry(
    ...
    :param provided_foe_two_status: Whether foe_2 is present or has disappeared.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :return: Function prints messages, and returns 'provided_foe_two_flag',
    'provided_foe_two_status' for use in later functions.
    """
    if provided_mode == "developer":
...
def foe_appearance(
    ...
    :param provided_foe_appear: The turn the foe will appear on the map.
    :param provided_foe_status: Whether the foe is present of has disappeared.
    :return: Function prints messages, calls 'art_printer()', and returns
    'new_foe_status' / 'provided_foe_status' for use in later functions.
    """
    if provided_turn_count < provided_foe_appear:
...
def foe_behave(
    ...
    :return: Function prints messages, and returns 'provided_foe_y',
    'provided_foe_x', 'provided_last_move', 'provided_foe_status',
    'provided_reappear_count' for use in later functions.
    """
    opposites = {
        'up': 'down',
        'left': 'right',
...
def foe_disappear(
    ...
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_name: The name of either the 'foe' or the 'accomplice'.
    :return: Function prints messages, and returns 'provided_foe_status',
    'reappear_count' / 'provided_reappear_count' for use in later functions.
    """
...
def foe_reappear(
    ...
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_name: The name of either the 'foe' or the 'accomplice'.
    :return: Function prints messages, and returns 'new_foe_y', 'new_foe_x',
    'new_foe_status', 'caught_flag', 'reappear_flag' for use in later functions.
    """
    if provided_mode == 'developer':
...
def forced_move(
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: Function returns 'new_room', 'provided_y', 'provided_x',
    'provided_d_map' for use in later functions.
    """
...
def turn_counter(provided_turn_count):
    ...
    :param provided_turn_count: The current turn number for the game.
    :return: Function returns 'provided_turn_count' for use in later functions.
    """
...
def map_discover(
    ...
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: Function prints messages, and returns 'altered_d_map' for use in
    later functions.
    """
...
def assign_evidence(
    ...
    :param provided_map: The current game map.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :return: Function prints messages, and returns 'provided_evidence_list' for
...
def find_evidence(
    ...
    :param provided_evidence_list: The evidence to be found in the game.
    :param provided_found_list: The evidence the player has found.
    :return: Function prints messages, and returns 'filtered_evidence_list' /
    'provided_evidence_list', 'provided_found_list' for use in later functions.
    """
...
def delete_by_yx(
    ...
    :return: Function deletes found evidence from 'provided_evidence_list'.
    """
...
def evidence_count(
    ...
    :param provided_all_evidence_turn_count: The turn number when all evidence
    has been found.
    :return: Function returns 'new_win_condition', 'evidence_turn_count' to
...
def art_printer(provided_art):
    ...
    :param provided_art: The art to be printed from the game data files.
    :return: Function prints messages and returns 'None'.
    """
    print(provided_art)
