...
def iterate_maps(
    ...
    Prints all of the maps in the games files using the 'map_printer()'.
...
def main_loop(
    ...
    :param provided_room: Room fed to the function where the player is.
    :param provided_y: The player's current y co-ordinate.
    :param provided_x: The player's current x co-ordinate.
    :param provided_mode: The mode generated by 'developer_mode()'.
    :param provided_map_list: The list of maps fed to this function.
    :return: Processes data, calls 'choose_direction() and returns 'None'.
    """
...
def choose_direction(
    ...
    The available directions for each room can be seen in the map data for the
    game in 'game_maps.py'.
    Impossible directions cannot be chosen, prompting another input attempt.
    A 'new_room' variable is generated for the yx co-ordinates after the move.
    The map can also be called by calling the 'map_printer()' function.

    :param provided_room: The current room fed to this function.
    :param provided_map: The current map fed to this function.
    :param provided_y: The current y co-ordinate.
    :param provided_x: The current x co-ordinate.
    :return: 'new_room', 'provided_y', 'provided_x' returned to use in the
    game code.
    """
...
def display_position(
    ...
    The room object will be changed depending on player or foe position in a
    room.
    The player is displayed as an 'X' and the foe as a '!'.

    :param provided_map: Current map fed to this function.
    ...
    :return: 'altered_map' for use in the rest of the code.
    """
...
def map_printer(
    ...
    :param map_provided: The current map fed to this function.
