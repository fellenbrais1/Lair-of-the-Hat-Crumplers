...
def iterate_maps(
    ...
    :param provided_map_list: The list of maps fed to this function.
    :param provided_foe_y: Current y co-ordinate fed to this function.
    :param provided_foe_x: Current x co-ordinate fed to this function.
    :param provided_turn_count: Current turn count fed to this function.
...
def main_loop(
    ...
    :param provided_foe_y:
    :param provided_foe_x:
    :param provided_turn_count:
    :param provided_foe_appear:
    :return:
    """
...
def map_printer(
    ...
    :param provided_map:
    :param provided_map_id:
    :param provided_danger_level:
    :param provided_y:
    :param provided_x:
    :param provided_foe_y:
    :param provided_foe_x:
